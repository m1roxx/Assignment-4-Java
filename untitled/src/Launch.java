...
public class Launch {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Создание объекта наблюдателя для уведомлений
            SmartphoneObserver notificationObserver = new NotificationObserver();

            // Подписка или отписка наблюдателя в зависимости от ответа пользователя
            System.out.print("Would you like to receive notifications about smartphone updates? (yes/no): ");
            String answer = scanner.nextLine().trim().toLowerCase();
            if (answer.equals("yes")) {
                manager.addObserver(notificationObserver);
                System.out.println("You will receive notifications about smartphone updates.");
            } else {
                System.out.println("You will not receive notifications about smartphone updates.");
            }
